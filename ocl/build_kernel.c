// This previously relied on its headers to include other headers
// that were only required by the C source, not the header in
// question. Doesn't make a lot of sense... confusing as all hell.
